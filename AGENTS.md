...
Repo guide for `komari-theme-natrue`.
...
- `dist/`
- `komari-theme-natrue-build-<sha>.zip`
...
- Respect existing generated outputs and naming patterns, especially `komari-theme-natrue-build-<sha>.zip`
